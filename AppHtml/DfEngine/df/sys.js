...
// <=IE11 matches support.
if (!Element.prototype.matches) {
    Element.prototype.matches = function (sSelector) {
        let aElements = df.dom.query(this.parentNode, sSelector, true);
        for (let i = 0; i < aElements.length; i++) {
            if (aElements[i] === this) return true;
        }
        return false;
    }
}